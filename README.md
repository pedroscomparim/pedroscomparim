...
`HLA Federation` `PitchRTI` `OneArc` `SKF Framework` `4G/5G Wireless` `Backbone Networks` `AWS Bedrock`
...
**[TrashTrack](https://github.com/Lylica/trashTrack)**  
IoT urban waste monitoring system with real-time sensor data visualization.  
`JavaScript` `Chart.js` `ThingSpeak`

**[CS50x](https://github.com/pedroscomparim/cs50)**  
Harvard's Introduction to Computer Science — solutions for all problem sets covering C, Python, SQL, and Web Development.  
`C` `Python` `SQL`